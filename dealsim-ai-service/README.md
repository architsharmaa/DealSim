# DealSim Microservice

The intelligence layer of DealSim. A dedicated service for orchestration, conversation state, and evaluation.
...
- **Structured Output**: Custom evaluation pipeline that parses response into strictly typed JSON for the core API.
...
- `/src/services/llmGateway`: Wrapper for OpenAI interaction with retry logic.
